...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		{
			path: '/dashboard/default',title: 'Dashboards', icon: 'home', type: 'link', active: true, 
			// children: [
		...
		{
			 path : '/pages/addpatient', title: 'Add Patient ', icon:'users', type: 'link', active: false, 
			// children: [
		...
		{
			path : '/pages/allpatient',title: 'All Patient', icon: 'activity', type: 'link', active: false,
			//  children: [
			// 	// { path: '/widgets/general', title: 'General', type: 'link' },
			// 	// { path: '/widgets/chart', title: 'Chart', type: 'link' }
			// 	// { path: '/widgets/chart', title: 'Chart', type: 'link' }
